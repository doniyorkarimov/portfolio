    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.CharField(help_text='Client, e.g., Google', max_length=100)),
                ('service', models.CharField(help_text='Service, e.g., Web Development', max_length=100)),
                ('project_type', models.CharField(help_text='Project type e.g., Full Stack', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('university', models.CharField(help_text='University, e.g., University of Miami', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_year', models.CharField(help_text='Start year, e.g., 2005', max_length=4)),
                ('end_year', models.CharField(help_text='End year, e.g., 2008', max_length=4)),
                ('position', models.CharField(help_text='Position, e.g., Software Engineer', max_length=100)),
                ('company', models.CharField(help_text='Company, e.g., Google', max_length=100)),
                ('description', tinymce.models.HTMLField(help_text='Description, e.g., Software Engineer at Google')),
                ('about_me', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='portfolio.aboutme')),
            ],
        ),
        migrations.CreateModel(
